...
const balances: AccountBalance[] = [
  { id: 1, accountId: 10, balance: 1000, recordedAt: '2026-02-01', linkedTransactionId: null, source: 'manual' },
  { id: 2, accountId: 20, balance: 200, recordedAt: '2026-02-01', linkedTransactionId: null, source: 'manual' },
]
...
describe('balancePreview', () => {
  ...
  it('ignores snapshots dated after the transaction', () => {
    const future: AccountBalance[] = [{ id: 3, accountId: 10, balance: 5000, recordedAt: '2026-12-01', linkedTransactionId: null, source: 'manual' }]
