...
const routes = [
  ...
  { path: '/hsa', name: 'hsa', component: () => import('./pages/HsaExpenses.vue') },
  ...
  { path: '/settings/suppress-rules', name: 'settings-suppress-rules', component: () => import('./pages/settings/SuppressRules.vue') },
