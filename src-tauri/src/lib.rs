...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::hsa_expenses::list_hsa_expenses_cmd,
            commands::hsa_expenses::get_hsa_expense_cmd,
            commands::hsa_expenses::create_hsa_expense_cmd,
            commands::hsa_expenses::update_hsa_expense_cmd,
            commands::hsa_expenses::delete_hsa_expense_cmd,
            ...
            commands::storage::list_hsa_attachments_cmd,
            commands::storage::upload_hsa_attachment_cmd,
            commands::storage::delete_hsa_attachment_cmd,
            commands::storage::open_hsa_attachment_cmd,
            ...
            simplefin::simplefin_sync_range,
