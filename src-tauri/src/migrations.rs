...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 18,
        name: "payment_as_expense",
        sql: include_str!("../migrations/0018_payment_as_expense.sql"),
    },
    Migration {
        version: 19,
        name: "suppress_rules",
        sql: include_str!("../migrations/0019_suppress_rules.sql"),
    },
    Migration {
        version: 20,
        name: "withdrawal_rate",
        sql: include_str!("../migrations/0020_withdrawal_rate.sql"),
    },
    Migration {
        version: 21,
        name: "simplefin_pending",
        sql: include_str!("../migrations/0021_simplefin_pending.sql"),
    },
];
